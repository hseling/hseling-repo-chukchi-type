...
## Development environment and release process
 ...
 - create virtualenv with Flask and Chukchi Type installed into it (latter is installed in
...
install it (`pip install hseling_api_chukchi_type.tar.gz`), ensure that configuration file exists and
`HSELING_API_CHUKCHI_TYPE_SETTINGS` environment variable points to it, ensure that user has access to the
